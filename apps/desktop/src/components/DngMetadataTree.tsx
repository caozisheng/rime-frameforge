...
interface DngMetadataTreeProps { readonly descriptor: DngFrameDescriptor; readonly sequence?: DngSequenceDescriptor | null; readonly lifecycleState: LifecycleState; readonly frameIndex: number | null; readonly frameCount: number }
...
export function DngMetadataTree({ descriptor, sequence = null, lifecycleState, frameIndex, frameCount }: DngMetadataTreeProps) {
  const visibleFrame = frameIndex ?? descriptor.frameIndex;
  const groups: readonly InspectorTreeGroup[] = buildDngMetadataGroups(descriptor, sequence, visibleFrame);
