...
export function packFusedUniforms(
  ...
  view.setFloat32(32, demosaicParameters.vng_threshold, true);
  view.setFloat32(36, demosaicParameters.ahd_l_threshold, true);
  view.setFloat32(40, demosaicParameters.ahd_c_threshold_sq, true);
  view.setUint32(44, frameIndex, true);
